...
namespace DamriCustomTrack
{
    public class TweenMixerBehaviour : PlayableBehaviour
    {
        ...
        public bool useStartRectTranform { get; set; }
        ...
        public override void ProcessFrame(Playable playable, FrameData info, object playerData)
        {
            ...
            {
                transform.localPosition = startPosition + blendedPosition;
                transform.localRotation = startRotation * Quaternion.Euler(blendedRotation);
                transform.localScale = startScale + blendedScale;
            }
            else
            {
                transform.localPosition = defaultPosition + blendedPosition;
                transform.localRotation = defaultRotation * Quaternion.Euler(blendedRotation);
